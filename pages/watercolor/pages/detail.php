<?php
  ...
  $data = [];
  $sql = $db->query("SELECT * FROM watercolor WHERE id = '$id'");
...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="watercolor_pages_css.css" type="text/css">
    <link rel="shortcut icon" href="../../../images/logo.png" type="image/x-icon">

    <title>Morgana's | Watercolor</title>
  ...
  <body>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item active">
            <a class="nav-link mr-2" href="../watercolor.php">Watercolor</a>
          </li>
          <li class="nav-item">
            <a class="nav-link mr-2" href="../../graphicsdesign/graphicsdesign.php">Graphics Design</a>
          </li>
          <li class="nav-item">
    ...
    <div style="background: url(../../../images/background2.png);" class="container-fluid custom_background_color text-center custom_height_body pt-5 pb-5">
      <div class="container">
        <div class="row">
          <?php while($row = mysqli_fetch_array($sql)) {?>
            <div class="col-md-1"></div>
            <div class="col-md-5 mb-5">
              <img class="img-fluid image_custom_size" src="../../../images/watercolor/<?php echo $row['thumbnail']?>">
            </div>
            <div class="col-md-5 text-left">
              <h1 class="border-bottom border-dark pb-2 mb-5"><?php echo $row['title']?></h1>
              <p class="mb-5"><?php echo $row['description']?></p>
              <a href="../watercolor.php" class="btn btn-light">Return to previous page</a>
            </div>
            <div class="col-md-1"></div>
          <?php }?>
        </div>
