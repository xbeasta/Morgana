...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="watercolor.css" type="text/css">
  ...
  <body>
    ...
    <div class="container-fluid custom_background_color pt-5 pb-2">
      <div class="row">
        <div class="col-md-12 text-center pt-5">
          <h1 class=""><a class="watercolor_h_a" href="watercolor.php">Watercolor</a></h1>
        </div>
      </div>
    </div>

    <div style="" class="container-fluid custom_background_color pb-5 custom_height_body">
      <div id="watercolor" class="row">
                ...
                watercolor.append('\
                  <div class="col-md-3 text-center mb-2">\
                    <div class="card shadow-sm" style="">\
                      <img src="../../images/watercolor/'+value.thumbnail+'" class="card-img-top">\
                      <div class="card-body">\
